 ...
 */
@Repository
public class UserDseDaoOld extends DseDaoSupport {

    /** Logger for DAO. */
    private static final Logger LOGGER = LoggerFactory.getLogger(UserDseDaoOld.class);
     ...
     */
    public UserDseDaoOld(DseSession dseSession) {
        super(dseSession);
    }
